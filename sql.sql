...
CREATE TABLE IF NOT EXISTS `account` (
  ...
  `compauth` varchar(32) default NULL,
...
CREATE TABLE IF NOT EXISTS `amount` (
  ...
  `passingprice` int(11) default NULL,
  `collectionform` int(11) default NULL,
  `costprice` int(11) default NULL,
  `collectionprice` int(11) default NULL,
  `innum` int(11) default NULL,
  `outcasenum` int(11) default NULL,
  `outbaranum` int(11) default NULL,
  `oriconnum` int(11) default NULL,
  `cartnum` int(11) default NULL,
  `linenum` int(11) default NULL,
  `worktime` int(11) default NULL,
  `inlinenum` int(11) default NULL,
  `urgentsupplement` int(11) default NULL,
  `itemnum` int(11) default NULL,
  `irregular1` varchar(512) default NULL,
  `irregular2` varchar(512) default NULL,
  `irregular3` varchar(512) default NULL,
  `irregular4` varchar(512) default NULL,
  `irregular5` varchar(512) default NULL,
  `irregularstart` time default NULL,
  `irregularend` time default NULL,
  `reporter` varchar(64) default NULL,
  `stockprice` int(11) default NULL,
  `usefloor` int(11) default NULL,
  `created_at` datetime default NULL,
  `updated_at` datetime default NULL,
  PRIMARY KEY  (`id`),
  KEY `amount_FI_1` (`company_id`),
  KEY `amount_FI_2` (`department_id`),
  KEY `amount_FI_3` (`unit_id`),
  KEY `amount_FI_4` (`category_id`)
...
CREATE TABLE IF NOT EXISTS `attendance` (
  ...
  `timebreak` time default NULL,
  `timework` time default NULL,
  `timeover` time default NULL,
  `targettimestart` time default NULL,
  `targettimeend` time default NULL,
  `targettimebreak` time default NULL,
  `targettimework` time default NULL,
  `targettimeover` time default NULL,
  `resulttimestart` time default NULL,
  `resulttimeend` time default NULL,
  `resulttimebreak` time default NULL,
  `resulttimework` time default NULL,
  `resulttimeover` time default NULL,
  `restflg` int(11) NOT NULL,
  `costprice` int(11) default NULL,
  `section_id` int(11) default NULL,
  PRIMARY KEY  (`id`),
  KEY `attendance_FI_1` (`company_id`),
  KEY `attendance_FI_2` (`department_id`),
  KEY `attendance_FI_3` (`unit_id`),
  KEY `attendance_FI_4` (`staff_id`)
...
CREATE TABLE IF NOT EXISTS `balance` (
  ...
  PRIMARY KEY  (`id`),
  KEY `balance_FI_1` (`company_id`),
  KEY `balance_FI_2` (`department_id`),
  KEY `balance_FI_3` (`unit_id`)
...
CREATE TABLE IF NOT EXISTS `department` (
  ...
  `avaragemethod` varchar(32) NOT NULL,
  `costprice` int(11) default NULL,
  `costpriceavarage` int(11) NOT NULL,
  `collectionpattern` int(11) default NULL,
  `oriconcoefficient` int(11) default NULL,
  `cartcoefficient1` int(11) default NULL,
  `cartcoefficient2` int(11) default NULL,
  `facilityfixedprice` int(11) default NULL,
  `normalfixedprice` int(11) default NULL,
  `fixturefixedprice` int(11) default NULL,
  `etcfixedprice` int(11) default NULL,
  `timebase` time NOT NULL,
  `operationweek0` int(11) default NULL,
  `operationweek1` int(11) default NULL,
  `operationweek2` int(11) default NULL,
  `operationweek3` int(11) default NULL,
  `operationweek4` int(11) default NULL,
  `operationweek5` int(11) default NULL,
  `operationweek6` int(11) default NULL,
  `aimcreate1` int(11) default NULL,
  `aimlabor1` int(11) default NULL,
  `aimcreate2` int(11) default NULL,
  `aimlabor2` int(11) default NULL,
  `aimcreate3` int(11) default NULL,
  `aimlabor3` int(11) default NULL,
  `aimcreate4` int(11) default NULL,
  `aimlabor4` int(11) default NULL,
  `aimcreate5` int(11) default NULL,
  `aimlabor5` int(11) default NULL,
  `aimcreate6` int(11) default NULL,
  `aimlabor6` int(11) default NULL,
  `aimcreate7` int(11) default NULL,
  `aimlabor7` int(11) default NULL,
  `aimcreate8` int(11) default NULL,
  `aimlabor8` int(11) default NULL,
  `aimcreate9` int(11) default NULL,
  `aimlabor9` int(11) default NULL,
  `aimcreate10` int(11) default NULL,
  `aimlabor10` int(11) default NULL,
  `aimcreate11` int(11) default NULL,
  `aimlabor11` int(11) default NULL,
  `aimcreate12` int(11) default NULL,
  `aimlabor12` int(11) default NULL,
  `limitcreate` int(11) NOT NULL,
  `limitlabor` int(11) NOT NULL,
  `targetratiolabor` int(11) NOT NULL,
  `irregular1` varchar(64) default NULL,
  `irregular2` varchar(64) default NULL,
  `irregular3` varchar(64) default NULL,
  `irregular4` varchar(64) default NULL,
  `irregular5` varchar(64) default NULL,
  PRIMARY KEY  (`id`),
  KEY `department_FI_1` (`company_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `quota` (
  ...
  `department_id` int(11) default NULL,
  `unit_id` int(11) default NULL,
  `qyear` int(11) default NULL,
  `qmonth` int(11) default NULL,
  `aimcreate1` int(11) default NULL,
  `aimcreate2` int(11) default NULL,
  `aimcreate3` int(11) default NULL,
  `aimcreate4` int(11) default NULL,
  ...
  `aimcreate11` int(11) default NULL,
  `aimcreate12` int(11) default NULL,
  `aimcreate13` int(11) default NULL,
  `aimcreate14` int(11) default NULL,
  `aimcreate15` int(11) default NULL,
  `aimcreate16` int(11) default NULL,
  `aimcreate17` int(11) default NULL,
  `aimcreate18` int(11) default NULL,
  `aimcreate19` int(11) default NULL,
  `aimcreate20` int(11) default NULL,
  `aimcreate21` int(11) default NULL,
  `aimcreate22` int(11) default NULL,
  `aimcreate23` int(11) default NULL,
  `aimcreate24` int(11) default NULL,
  `aimcreate25` int(11) default NULL,
  `aimcreate26` int(11) default NULL,
  `aimcreate27` int(11) default NULL,
  `aimcreate28` int(11) default NULL,
  `aimcreate29` int(11) default NULL,
  `aimcreate30` int(11) default NULL,
  `aimcreate31` int(11) default NULL,
  `aimlabor1` int(11) default NULL,
  `aimlabor2` int(11) default NULL,
  `aimlabor3` int(11) default NULL,
  `aimlabor4` int(11) default NULL,
  ...
  `aimlabor11` int(11) default NULL,
  `aimlabor12` int(11) default NULL,
  `aimlabor13` int(11) default NULL,
  `aimlabor14` int(11) default NULL,
  `aimlabor15` int(11) default NULL,
  `aimlabor16` int(11) default NULL,
  `aimlabor17` int(11) default NULL,
  `aimlabor18` int(11) default NULL,
  `aimlabor19` int(11) default NULL,
  `aimlabor20` int(11) default NULL,
  `aimlabor21` int(11) default NULL,
  `aimlabor22` int(11) default NULL,
  `aimlabor23` int(11) default NULL,
  `aimlabor24` int(11) default NULL,
  `aimlabor25` int(11) default NULL,
  `aimlabor26` int(11) default NULL,
  `aimlabor27` int(11) default NULL,
  `aimlabor28` int(11) default NULL,
  `aimlabor29` int(11) default NULL,
  `aimlabor30` int(11) default NULL,
  `aimlabor31` int(11) default NULL,
  PRIMARY KEY  (`id`),
  KEY `quota_FI_1` (`company_id`),
  KEY `quota_FI_2` (`department_id`),
  KEY `quota_FI_3` (`unit_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `shift` (
  `id` int(11) NOT NULL auto_increment,
  `staff_id` int(11) default NULL,
  `weekstart1` time default NULL,
  `weekend1` time default NULL,
  `weekstart2` time default NULL,
  `weekend2` time default NULL,
  `weekstart3` time default NULL,
  `weekend3` time default NULL,
  `weekstart4` time default NULL,
  `weekend4` time default NULL,
  `weekstart5` time default NULL,
  `weekend5` time default NULL,
  `weekstart6` time default NULL,
  `weekend6` time default NULL,
  `weekstart0` time default NULL,
  `weekend0` time default NULL,
  PRIMARY KEY  (`id`),
  KEY `shift_FI_1` (`staff_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `staff` (
  ...
  `hiringCode` int(11) default NULL,
  `jobCode` int(11) default NULL,
  `sectionCode` int(11) default NULL,
  `shiftPatternCode` varchar(32) NOT NULL,
  `contractTimeStart` time default NULL,
  `contractTimeEnd` time default NULL,
  `restTime` time default NULL,
  `workTime` time default NULL,
  `hourCostPrice` int(11) default NULL,
  `defaultHoliday` varchar(32) default NULL,
  `note1` varchar(128) default NULL,
  `note2` varchar(128) default NULL,
  PRIMARY KEY  (`staffCode`),
  KEY `staff_FI_1` (`deptCode`),
  KEY `staff_FI_2` (`unitCode`),
  KEY `staff_FI_3` (`hiringCode`),
  KEY `staff_FI_4` (`jobCode`),
  KEY `staff_FI_5` (`sectionCode`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `threshold` (
  ...
  `workschedule` int(11) default NULL,
  `aimcreate` int(11) default NULL,
  `aimlabor` int(11) default NULL,
  `timezonestaffnum` float default NULL,
  PRIMARY KEY  (`id`),
  KEY `threshold_FI_1` (`company_id`),
  KEY `threshold_FI_2` (`department_id`),
  KEY `threshold_FI_3` (`unit_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `work` (
  ...
  `section_id` int(11) default NULL,
  `name` varchar(128) default NULL,
  `wyear` int(11) default NULL,
  `wmonth` int(11) default NULL,
  `wweek` int(11) default NULL,
  `timestart` time default NULL,
  `timeend` time default NULL,
  `staffnum` int(11) default NULL,
  `amountaverage` int(11) default NULL,
  `fecundity` int(11) default NULL,
  PRIMARY KEY  (`id`),
  KEY `work_FI_1` (`section_id`)
...
CREATE TABLE IF NOT EXISTS `works` (
  ...
  `fecundity` int(11) default NULL,
  PRIMARY KEY  (`id`),
  KEY `works_FI_1` (`department_id`),
  KEY `works_FI_2` (`section_id`)
